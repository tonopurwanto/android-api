...
class ApiController extends Controller
{
     ...
     * @return mixed
     */
    public function respondUnauthorized($message = 'Unauthorized', $status = null)
    {
        return $this->setStatusCode(HttpResponse::HTTP_UNAUTHORIZED)->respondWithError($message, $status);
    }
    ...
    {
        return $this->setStatusText($message)->respond(compact('message'));
//        return $this->respond([
//            'message'     => $message,
...
//        ]);
    ...
    {
        $response = HttpResponse::create($data, $this->getStatusCode(), $headers);
        $response->setStatusCode($this->getStatusCode(), $this->getStatusText());
